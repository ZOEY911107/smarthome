...
var synGetPersonList = function (GroupId) { //人脸识别API
  ...
  let params = '{"GroupId":"' + GroupId + '","Limit":100}' //拼接参数
...
exports.main = async (event, context) => {
  ...
  datas = await synGetPersonList(event.GroupId) //调用异步函数，向腾讯云API发起人脸检测请求
  console.log(datas)
  return datas
}